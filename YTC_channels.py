...
channel_metadata = {
    ...
    'UCFx1nseXKTc1Culiu3neeSQ': {  # REPORTER
        'group_title': 'news',
        'channel_name': '106',
    ...
    'UCf8w5m0YsRa8MHQ5bwSGmbw': {  # ASIANET NEWS
        'group_title': 'news',
        'channel_name': '107',
    ...
    'UCP0uG-mcMImgKnJz-VjJZmQ': {  # MANORAMA NEWS
        'group_title': 'news',
        'channel_name': '108',
    ...
    'UC-f7r46JhYv78q5pGrO6ivA': {  # MEDIAONE
        'group_title': 'news',
        'channel_name': '109',
    ...
    'UC6SP_igv78fiJhhy_voqpIg': {  # PUDHARI
        'group_title': 'news',
        'channel_name': '110',
    ...
    'UCwXrBBZnIh2ER4lal6WbAHw': {  # MATHURBHUMI
        'group_title': 'news',
        'channel_name': '111',
