...
channel_metadata = {
    ...
    'UCATUkaOHwO9EP_W87zCiPbA': {  # Independent Television
        'group_title': 'Bangla News',
        'channel_name': 'BD | Independent Television',
    ...
    'UC8NcXMG3A3f2aFQyGTpSNww': {  # Channel i News
        'group_title': 'Bangla News',
        'channel_name': 'BD | Channel i News',
    ...
    'UCb2O5Uo4a26CdTE7_2QA-jA': {  # NEWS24 Television
        'group_title': 'Bangla News',
        'channel_name': 'BD | NEWS24 Television',
